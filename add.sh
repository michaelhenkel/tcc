...
./3tccClient.py create protocolprocessor -host 192.168.1.2 -n pp1 -ip 192.168.1.80 -vip 10.0.0.1
./3tccClient.py create protocolprocessor -host 192.168.1.3 -n pp2 -ip 192.168.1.81 -vip 10.0.0.2
./3tccClient.py create protocolprocessor -host 192.168.1.4 -n pp3 -ip 192.168.1.82 -vip 10.0.0.3
./3tccClient.py create virtualrouter -host 192.168.1.2 -n vr1 -ip 192.168.1.70 -pp pp1
./3tccClient.py create virtualrouter -host 192.168.1.3 -n vr2 -ip 192.168.1.71 -pp pp2
./3tccClient.py create virtualrouter -host 192.168.1.4 -n vr3 -ip 192.168.1.72 -pp pp3
...
./3tccClient.py create service -n svc3 -sn 3.0.0.0/24 -t t3 -cust cust3 -rt 1:3 -m l2 -cv 0
