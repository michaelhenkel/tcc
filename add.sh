...
./tccClient.py add terminal -host 192.168.1.66 -n t2 -ip 192.168.1.91 -vip 10.0.0.11 -pp pp2
...
./tccClient.py add endpoint -n ep1 -svc svc1 -et lxc
./tccClient.py add endpoint -n ep2 -svc svc2 -et lxc
./tccClient.py add endpoint -n ep3 -svc svc3 -et lxc
./tccClient.py add endpoint -n ep4 -svc svc4 -et lxc
